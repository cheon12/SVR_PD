...
class Control(PID):
    ...
    def V_cal(self):
        ...
        for key in self.data_x.keys():
            self.data_x['PID']['x'] += self.data_x['PID']['ddx'] *self.dt* self.dt
            #self.data_x['PID']['x']



        for key in self.data_z.keys():
            self.data_z['PID']['z'] += self.data_z['PID']['ddz'] *self.dt* self.dt
            #self.data_z['PID']['z']


        for key in self.data_theta.keys():
            self.data_theta['PID']['theta'] += self.data_theta['PID']['ddtheta'] *self.dt* self.dt
